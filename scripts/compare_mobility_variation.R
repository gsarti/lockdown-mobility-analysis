...
plot(graph_pre, vertex.size=5, edge.width=plot_size(graph_pre), edge.arrow.size=0.02)
plot(graph_mid, vertex.size=5, edge.width=plot_size(graph_mid), edge.arrow.size=0.02)
plot(graph_post, vertex.size=5, edge.width=plot_size(graph_post), edge.arrow.size=0.02)
